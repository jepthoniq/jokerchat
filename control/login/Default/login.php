			...
			<div id="login_all" class="pad30">
				...
				<div class="intro_social_container">
					<div class="intro_social_content">
						...
						<img onclick="window.location.href='<?php echo getSocialLoginCallbackUrl('facebook'); ?>'" class="intro_social_btn bclick" src="<?php echo $data['domain']; ?>/default_images/social/facebook.svg"/>
						<?php } ?>
						<?php if(boomSocial('google_login')){ ?>
						<img onclick="window.location.href='<?php echo getSocialLoginCallbackUrl('google'); ?>'" class="intro_social_btn bclick" src="<?php echo $data['domain']; ?>/default_images/social/google.svg"/>
						<?php } ?>
						<?php if(boomSocial('twitter_login')){ ?>
						<img onclick="window.location.href='<?php echo getSocialLoginCallbackUrl('twitter'); ?>'" class="intro_social_btn bclick" src="<?php echo $data['domain']; ?>/default_images/social/twitter.svg"/>
						<?php } ?>
					</div>
				</div>
				<?php } ?>
