...
else if( $command[0] == '/setonline' && boomAllow(100)){
   $mysqli->query("UPDATE boom_users SET last_action = '" . time() . "'");
	echo boomCode(99);
	die();
}	
else if( $command[0] == '/topic' && (boomAllow(70) || boomRole(5)) ){
...
else if($command[0] == '/removeonair' && canManageDj()){
...
else if($command[0] == '/setonair'  && canManageDj()){
...
else if($command[0] == '/setdj' && canManageDj()){
...
else if($command[0] == '/removedj'  && canManageDj()){
