<div id="call_incoming" data="<?php echo $boom['call_id']; ?>" data-call="0" class="pad25">
    ...
    <div class="modal_control">
        <div class="centered_element">
            <button onclick="acceptCall(<?php echo $boom['call_id']; ?>);" class="ok_btn reg_button"><i class="ri-phone-line"></i> <?php echo $lang['answer']; ?></button>
            <button onclick="declineCall(<?php echo $boom['call_id']; ?>);" class="delete_btn reg_button"><i class="ri-close-circle-line"></i><?php echo $lang['decline']; ?></button>
        </div>
    </div>
    <?php if(playSound(5)){ ?>
    <?php } ?>
