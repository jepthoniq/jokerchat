...
$hunter_info = fuse_user_data($boom['call_hunter']);
$target_info = fuse_user_data($boom['call_target']);
?>
<div id="admincall<?php echo $boom['call_id']; ?>" class="sub_list_item members_item blisting">
	...
	<div class="sub_list_name" onclick="getCallInfo(<?php echo $boom['call_id']; ?>);">
		<p class="bold"><?php echo $hunter_info['user_name']; ?> (With) <?php echo $target_info['user_name']; ?>  - 🔓(Room) - <?php echo $boom['call_room']; ?></p>
