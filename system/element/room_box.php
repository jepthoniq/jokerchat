...
?>
<div data-room="<?php echo $boom['room_id']; ?>" class="room_element add_shadow element_color" onclick="switchRoom(<?php echo $boom['room_id']; ?>, <?php echo $ask; ?>, <?php echo $boom['access']; ?>);">
	<div class="btable">
		<div class="bcell">
		</div>
		<div class="room_icon">
	...
	<div class="btable">
		<div class="bcell">
			...
			<div class="room_count centered_element">
				<p class="default_color text_xreg"><?php echo $boom['room_count']; ?><i class="ri-group-line"></i></p>
			</div>
		</div>
	</div>
</div>